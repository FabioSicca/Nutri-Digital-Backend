...
export const micronutrientGoalsTable = pgTable('micronutrient_goals', {
  ...
  id_user: integer('id_user').notNull().references(() => usersTable.id, { onDelete: 'cascade' }),  
...
export type micronutrientGoals = InferSelectModel<typeof micronutrientGoalsTable>;