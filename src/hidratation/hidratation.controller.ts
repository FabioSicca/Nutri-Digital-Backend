...
export class HidratationController {
    ...
    public async addHidratationConsumed(
        ...
        return await this.consumedService.addHidratationConsumed(userId, req.mililiters);
    }
    ...
    public async GetHidratationConsumed(
        ...
        return await this.consumedService.getHidratationConsumed(userId, parsedDate);
    }
}